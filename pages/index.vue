    ...
    <div class="row" style="margin-top: 30px;">
      <div class="col">
        ...
        <ul v-if="isCreateBlockNew" style="padding-left: 0; list-style: none; margin-top: 10px;">
          ...
          <li class="text-monospace">3. Передайте эти ссылки, при первом открытии каждой будет происходить аквация с начислением стартового баланса.</li>
        </ul>
      </div>
    </div>
  </div>
...
<script>
  ...
  const ACTIVATE_FEE = '0.1'    // todo: change this place
